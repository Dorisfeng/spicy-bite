...
/*拼盘*/
INSERT INTO sb_menu_list VALUES(1,2,'images/menu/p_01.jpg','',"炭烧鸡排&amp;香烤罗非鱼",400,'鸡排，是现在小吃店里很流行的一种油炸类食品，香味可谓是十里飘香。呈米白色，上有“面包渣”似的小面团。里是鸡胸片成的肉片，须选上等淀粉将胸片肉与面渣相互结合，再过一遍纯豆油，变成“排”似的鸡胸肉。用铁板烧烤，大约5分钟左右即可熟，再将朝天椒榨成的油与风宁大酱做成的辣酱过一遍，辅以作料等，便成了外焦里嫩，香味可口的小派鸡排;香烤罗非鱼是一道简单的家常菜，主料是罗非鱼、洋葱、姜丝、老抽、生抽、白糖、白胡椒、绍酒、盐、迷迭香碎。',10,'');
INSERT INTO sb_menu_list VALUES(2,2,'images/menu/p_02.jpg','','美式乡村烤鸡&amp;烤猪肉排',380,'美式乡村烤鸡，是一道具有美式乡村风味的菜肴。主要原料有鸡肉、盐、味精等。制作者可依据自己的口味添加不同的调料制作各种口味的烤鸡。但烤鸡较为油腻，食用宜适量;烤猪肉排是由猪排等食材做出的一道菜品，口味是酱香。',10,'');
INSERT INTO sb_menu_list VALUES(3,2,'images/menu/p_03.jpg','','香辣烤鸡&amp;烤猪肉排',350,'香辣烤鸡具有浓厚的咸、香、辣气味，能够刺激食欲；辣度适中、柔和，能有效祛除鸡肉的腥味，并且伴有浓郁的咸香口感;可接受度广，辣味在口中持续时间较长，回味十足;烤猪肉排是由猪排等食材做出的一道菜品，口味是酱香。',10,'');
...
INSERT INTO sb_menu_list VALUES(5,2,'images/menu/p_05.jpg','',
	...
	10,'');
INSERT INTO sb_menu_list VALUES(6,2,'images/menu/p_06.jpg','','香辣烤鸡&amp;迷你牛肉汉堡',380,'香辣烤鸡具有浓厚的咸、香、辣气味，能够刺激食欲；辣度适中、柔和，能有效祛除鸡肉的腥味，并且伴有浓郁的咸香口感；可接受度广，辣味在口中持续时间较长，回味十足;牛肉汉堡是一款快餐食物，制作原料主要有牛肉馅、洋葱、胡萝卜等。是现代西式快餐中的主要食物，食用方便、风味可口、营养全面。',10,'');
...
INSERT INTO sb_menu_list VALUES(8,2,'images/menu/p_08.jpg','','特制猪肋排&amp;烤虎虾',400,'特制猪肋排（BBQPorkSpareribs）由整块肋排经过时时乐独创的秘方腌制，而后进行烧烤。肋排外侧涂满浓稠的酱汁，入口咀嚼，肉质绵软不散;烤虎虾的做法步骤1. 从虾枪剪开去虾囊，从背部剖开成两半去虾线。2. 调适量柠檬汁，抹到虾肉上，再用盐抹虾肉3. 把蒜蓉剁成泥，用黄油，橄榄油调匀，均堆到虾肉上，锡纸盘刷少量的油，放入虾。4. 根据自己喜好，可以再加点奶酪5. 烤箱预热后，200度烤10分钟，出炉时撒黑胡椒。其中一定要在锡纸盘上刷油，因为会比较香。',10,'');
INSERT INTO sb_menu_list VALUES(9,2,'images/menu/p_09.jpg','','西冷牛排&amp;香辣烤鸡',300,'西冷牛排（Sir loin)，主要是由上腰部的脊肉构成，西冷牛排按质量的不同又可分为小块西冷牛排（entrecte）和大块西冷牛排（sirloin steak）。事实上Sirloin是法语Sur（上）和Loin（柳肉）合成的词，即牛柳上方的肉。每份都在250—300克左右。西冷（Sir loin）即下腰肉，也被称为纽约客，因牛下腰部运动量较菲力沙朗多，故此部位肉质较粗一点;香辣烤鸡具有浓厚的咸、香、辣气味，能够刺激食欲；辣度适中、柔和，能有效祛除鸡肉的腥味，并且伴有浓郁的咸香口感;可接受度广，辣味在口中持续时间较长，回味十足。',10,'');
INSERT INTO sb_menu_list VALUES(10,2,'images/menu/p_10.jpg','','挪威香烤三文鱼&amp;烤虎虾',200,'香烤三文鱼是一道美食，制作原料主要有三文鱼，黑胡椒粉，蒜蓉;烤虎虾的做法步骤1. 从虾枪剪开去虾囊，从背部剖开成两半去虾线。2. 调适量柠檬汁，抹到虾肉上，再用盐抹虾肉3. 把蒜蓉剁成泥，用黄油，橄榄油调匀，均堆到虾肉上，锡纸盘刷少量的油，放入虾。4. 根据自己喜好，可以再加点奶酪5. 烤箱预热后，200度烤10分钟，出炉时撒黑胡椒。其中一定要在锡纸盘上刷油，因为会比较香。',998,'');
